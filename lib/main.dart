  ...
  runApp(
    MultiProvider(
      providers: [
        ...
        ChangeNotifierProvider(create: (_) => getIt<AssociationProvider>()),
        ...
        ChangeNotifierProvider(create: (_) => getIt<PhoneServiceProvider>()),
        ChangeNotifierProvider(
          create: (_) => getIt<ProfileImageServiceProvider>(),
        ),
      ],
