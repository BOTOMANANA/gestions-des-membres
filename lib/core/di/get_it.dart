...
import 'package:association_appli/data/services/phone_service_impl.dart';
import 'package:association_appli/data/services/profile_image_loader_service_impl.dart';
...
import 'package:association_appli/presentation/providers/profile_image_service_provider.dart';
...
Future registerUsecases() async {
  ...
  getIt.registerLazySingleton(() => PhoneServiceUsecase(callService: getIt()));
  getIt.registerLazySingleton(
    () => LoadProfileImageServiceUsecase(imageLoaderService: getIt()),
  );
}
...
Future registerProvider() async {
  ...
  getIt.registerLazySingleton(
    () => ProfileImageServiceProvider(serviceUsecase: getIt()),
  );
  ...
  getIt.registerLazySingleton(
    () => PhoneServiceProvider(phoneServiceUsecase: getIt()),
  );
...
Future<void> registerService() async {
  getIt.registerLazySingleton<ProfileImageLoaderService>(
    () => ProfileImageLoaderServiceImpl(),
  );
  ...
  getIt.registerLazySingleton<PhoneService>(() => PhoneServiceImpl());
}
